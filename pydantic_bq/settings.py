...
class Settings(BaseSettings):
    ...
    # Option 3: Path to credentials file
    google_application_credentials: Optional[str] = None

    @property
    def google_credentials(self) -> dict:
        """Build Google service account credentials dict from individual fields or base64."""
        # If base64 credentials provided, decode them
    ...
    def has_credentials(self) -> bool:
        ...
        return bool(
            ...
            or (self.g_project_id and self.g_private_key and self.g_client_email)
